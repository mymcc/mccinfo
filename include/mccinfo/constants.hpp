 ...
 */
inline constexpr size_t MCCSteamAppID = 976730;
/**
 * @brief The Steam&trade; executable basename + extension for Halo: The Master Chief
 * Collection&trade;.
 */
inline constexpr std::wstring_view SteamMCCexe = L"MCC-Win64-Shipping.exe";
inline constexpr std::string_view bSteamMCCexe = "MCC-Win64-Shipping.exe";
/**
 * @brief The Microsoft Store&trade; executable basename + extension for Halo: The Master Chief
 * Collection&trade;.
 */
inline constexpr std::wstring_view MicrosoftStoreMCCexe = L"MCCWinStore-Win64-Shipping.exe";
inline constexpr std::string_view bMicrosoftStoreMCCexe = "MCCWinStore-Win64-Shipping.exe";
/**
 ...
 */
inline constexpr std::wstring_view MCCexeRelativePath = L"mcc\\binaries\\win64";
/**
 * @brief The temporary directory Halo: The Master Chief Collection&trade; uses.
 */
inline constexpr std::wstring_view MCCTempPath = L"%AppData%\\..\\LocalLow\\MCC";
/**
 * @brief The array of all Halo: The Master Chief Collection&trade;'s individual title basenames.
 */
inline constexpr std::array<std::wstring_view, 6> GameBasenames = {L"halo1",     L"halo2", L"halo3",
