...
namespace predicates {
	static auto is_launcher = krabs::predicates::property_is(L"ImageFileName", std::string("mcclauncher.exe"));
	static auto is_eac = krabs::predicates::property_is(L"ImageFileName", std::string("EasyAntiCheat.exe"));
	static auto is_mcc = krabs::predicates::property_is(L"ImageFileName", std::string("MCC-Win64-Shipping.exe"));
