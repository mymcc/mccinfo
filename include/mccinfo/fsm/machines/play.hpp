...
struct play {
    ...
    return make_transition_table(
        *boost::sml::state<offline> + event<mcc_start> = boost::sml::state<waiting_on_launch>,
        ...
        boost::sml::state<identifying_session> + event<in_menus_not_identified> = boost::sml::state<identifying_match_state>,
        boost::sml::state<identifying_session> + event<mcc_terminate> = boost::sml::state<offline>,

        boost::sml::state<identifying_match_state> + event<match_paused> = boost::sml::state<in_match>,
